    ...
    <main class="dashboard-shell container-shell">
        <header class="dashboard-hero">
            ...
            <div class="hero-actions d-flex flex-wrap gap-2">
                <a href="/admin/regimes" class="quick-link btn btn-light btn-sm">Regimes</a>
                <a href="/admin/activites" class="quick-link btn btn-light btn-sm">Activites</a>
                <a href="/admin/codes" class="quick-link btn btn-light btn-sm">Codes</a>
                <a href="/admin/recettes" class="quick-link btn btn-light btn-sm">Recettes</a>
                <a href="/admin/planning-recettes" class="quick-link btn btn-light btn-sm">Planning recettes</a>
                <a href="/admin/logout" class="logout-link btn btn-warning btn-sm">Deconnexion admin</a>
            </div>
        </header>
