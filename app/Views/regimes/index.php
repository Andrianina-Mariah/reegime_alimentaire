...
<body>
    <main class="auth-shell profile-shell container-shell">
        ...
        <section class="auth-visual login-visual" aria-label="Presentation">
            ...
            <p>
                Objectif :
                <strong><?= esc($objectifLabel ?? 'Maintien') ?></strong>
        ...
        <section class="auth-card">
            ...
            <div class="summary-note" style="margin-bottom: 1rem;">
                Option Gold :
                <strong><?= esc($formatNumber($goldPrice)) ?> Ar</strong>
                (<?= esc($goldAccess) ?>)

                <br>

                Remise appliquée :
                <?= esc($discountLabel) ?> sur tous les régimes.
                ...
                <div class="suggestions-grid">
                    ...
                    <?php foreach ($regimes as $regime): ?>
                        ...
                        <article class="regime-card">
                            ...
                            <p class="regime-meta">
                                Durée :
                                <strong><?= esc((string) $duree) ?></strong>
                                jours
                            </p>
